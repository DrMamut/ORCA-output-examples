...
InpExt="inp"
InpDataExt="gbw uno unoloc uco qro prop opt xyz hess scfp mdcip lastscf scf esdinp tmp esd inp spectrum GS.hess TS.hess ES.hess GS TS ES esdinp.tmp"
OutExt="out"
OutDataExt="gbw uno unoloc uco qro prop opt xyz hess scfp mdcip lastscf scf esdinp tmp esd inp spectrum GS.hess TS.hess ES.hess GS TS ES esdinp.tmp"
